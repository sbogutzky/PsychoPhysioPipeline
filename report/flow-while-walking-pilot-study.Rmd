...
for(i in unique(as.numeric(data.5$subject))) {
  ...
  PlotModels(data.5.1$meanhr, data.5.1$mean.nsei, x.lim = c(80, 130), sub.line = 1.25, interval = 1)
  
  plot(data.5.1$meanhr, data.5.1$absorption, xlab = "Mean HR", ylab = "Absorption", pch = 21, bg = colors[1])
  PlotModels(data.5.1$meanhr, data.5.1$absorption, x.lim = c(80, 130), sub.line = 1.25, interval = 1)
