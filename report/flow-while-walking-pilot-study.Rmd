...
sessions <- factor(fss.features$session.start, levels = c("2014-05-27 12:34:52", "2014-05-28 14:13:25", "2014-06-02 13:55:29", "2014-06-03 12:29:16", "2014-06-04 12:09:38", "2014-06-05 13:18:49", "2014-06-06 11:08:16"), labels = c("27.05", "28.05", "02.06", "03.06", "04.06", "05.06", "05.06"))
...
```{r variables-session-wise, echo=FALSE, warning=FALSE, results="asis"}
  ...
  # Print latex table
  table                   <- xtable(feature.table, label = "table:variablen-nach-sitzung", align = "lyyyyyyyy", caption = "Variablen: Arithmetisches Mittel $\\pm$ Standardabweichung zu den sechs Sitzungen [$N = 4$] -+- \\emph{Anmerkung}: Bew. = Bewegungsaufwand.") 
...
outliers.2 <- c(9, 10, 11, 12, 16)
data.3 <- data.2[-outliers.2, ]
data.3$session <- factor(data.3$session, levels = c("27.05", "28.05", "03.06", "04.06", "05.06", "05.06"), labels = c("27.05", "28.05", "03.06", "04.06", "05.06", "05.06"))
```
...
```{r process-oriented-approach, eval = FALSE, echo=FALSE, include=FALSE}
