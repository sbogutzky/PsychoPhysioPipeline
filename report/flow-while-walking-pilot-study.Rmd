...
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 1, 4] ~ data.2[as.numeric(data.2[, 3]) == 4, 4], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 2, 4] ~ data.2[as.numeric(data.2[, 3]) == 3, 4], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 2, 4] ~ data.2[as.numeric(data.2[, 3]) == 4, 4], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 3, 4] ~ data.2[as.numeric(data.2[, 3]) == 4, 4], distribution="exact")

wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 1, 5] ~ data.2[as.numeric(data.2[, 3]) == 2, 5], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 1, 5] ~ data.2[as.numeric(data.2[, 3]) == 3, 5], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 1, 5] ~ data.2[as.numeric(data.2[, 3]) == 4, 5], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 2, 5] ~ data.2[as.numeric(data.2[, 3]) == 3, 5], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 2, 5] ~ data.2[as.numeric(data.2[, 3]) == 4, 5], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 3, 5] ~ data.2[as.numeric(data.2[, 3]) == 4, 5], distribution="exact")

wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 1, 6] ~ data.2[as.numeric(data.2[, 3]) == 2, 6], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 1, 6] ~ data.2[as.numeric(data.2[, 3]) == 3, 6], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 1, 6] ~ data.2[as.numeric(data.2[, 3]) == 4, 6], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 2, 6] ~ data.2[as.numeric(data.2[, 3]) == 3, 6], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 2, 6] ~ data.2[as.numeric(data.2[, 3]) == 4, 6], distribution="exact")
wilcoxsign_test(data.2[as.numeric(data.2[, 3]) == 3, 6] ~ data.2[as.numeric(data.2[, 3]) == 4, 6], distribution="exact")
