...
for (activity in activities) {
  for (user in users) {
    ...
    # Set factors
    subjects <- factor(fss.features$first.name, levels = c("anke", "birthe", "danilo", "hilke", "kiana","linde", "maike", "max", "susanna", "timo", "tobias", "vreni"), labels = c("Subject 1", "Subject 2", "Subject 3", "Subject 4", "Subject 5", "Subject 6", "Subject 7", "Subject 8", "Subject 9", "Subject 10", "Subject 11", "Subject 12"))
...
#[data.1$date == "2014-03-06" | data.1$date == "2014-05-28" | data.1$date == "2014-06-03" | data.1$date == "2014-06-04" |  data.1$date == "2014-06-16" | data.1$date == "2014-06-17" | data.1$date == "2014-06-18" | data.1$date == "2014-06-19" | data.1$date == "2014-07-23" | data.1$date == "2014-07-28" | data.1$date == "2014-07-29" | data.1$date == "2014-08-04", ]
