...
# Create data frame
data.1 <- rbind(data.1, data.frame(subject = subjects, session = sessions, measurement = measurements, absorption = fss.features[, 3], mean.hr = hrv.features[, 3], mean.stride = 60000 / stride.features[, 1], mean.nsei = cls.features[, 1], challenge = fss.features[, 5], skill = fss.features[, 6], fit = fss.features[, 8]))
