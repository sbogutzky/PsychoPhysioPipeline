...
data.1b <- rbind(read.csv(paste(root.path, "features/baseline/buse-patrick/fss-features.csv", sep = "")))
...
baseline.absorption <- data.2b$absorption
...
par("mfcol" = c(2, 4), mar = c(2.5, 2.5, 2.5, 3.5) + 0.1, mgp = c(1.5, .5, 0), las = 1, cex.axis = 0.8, tck = .03, cex.lab = .8, xaxs = "r", yaxs = "r")
