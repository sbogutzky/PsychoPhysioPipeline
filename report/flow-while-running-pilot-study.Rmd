...
outlier <- c(1, 5, 6, 7, 8, 9, 13, 17, 20)
# 1
plot(data.1$mean.nsei[-outlier], data.1$flow[-outlier], xlab = "Mean Normalized Shannon Entropy Index", ylab = "Flow", pch = 21, bg = "darkolivegreen1") 
linear.model <- lm(data.1$flow[-outlier] ~ data.1$mean.nsei[-outlier])
abline(linear.model)
summary(linear.model)
# 2
plot(data.1$mean.hr[-outlier], data.1$flow[-outlier], xlab = "Mean HR", ylab = "Flow", pch = 21, bg = "tomato")
linear.model <- lm(data.1$flow[-outlier] ~ data.1$mean.hr[-outlier])
abline(linear.model)
summary(linear.model)
#3
plot(data.1$mean.jerk.cost[-outlier], data.1$flow[-outlier], xlab = "Mean Jerk Cost", ylab = "Flow", pch = 23, bg = "deepskyblue") 
linear.model <- lm(data.1$flow[-outlier] ~ data.1$mean.jerk.cost[-outlier])
abline(linear.model)
summary(linear.model)
#4
plot(data.1$mean.cycle.interval[-outlier], data.1$flow[-outlier], xlab = "Mean Cycle Interval", ylab = "Flow", pch = 23, bg = "deepskyblue")
linear.model <- lm(data.1$flow[-outlier] ~ data.1$mean.cycle.interval[-outlier])
abline(linear.model)
summary(linear.model)
#5
plot(data.1$mean.nsei[-outlier], data.1$absorption[-outlier], xlab = "Mean Normalized Shannon Entropy Index", ylab = "Absorption", pch = 21, bg = "darkolivegreen1") 
linear.model <- lm(data.1$absorption[-outlier] ~ data.1$mean.nsei[-outlier])
abline(linear.model)
summary(linear.model)
#6
plot(data.1$mean.hr[-outlier], data.1$absorption[-outlier], xlab = "Mean HR", ylab = "Absorption", pch = 21, bg = "tomato") 
linear.model <- lm(data.1$absorption[-outlier] ~ data.1$mean.hr[-outlier])
abline(linear.model)
summary(linear.model)
#7
plot(data.1$mean.jerk.cost[-outlier], data.1$absorption[-outlier], xlab = "Mean Jerk Cost", ylab = "Absorption", pch = 23, bg = "deepskyblue") 
linear.model <- lm(data.1$absorption[-outlier] ~ data.1$mean.jerk.cost[-outlier])
abline(linear.model)
summary(linear.model)
#8
plot(data.1$mean.cycle.interval[-outlier], data.1$absorption[-outlier], xlab = "Mean Cycle Interval", ylab = "Absorption", pch = 23, bg = "deepskyblue") 
linear.model <- lm(data.1$absorption[-outlier] ~ data.1$mean.cycle.interval[-outlier])
abline(linear.model)
summary(linear.model)
```
