...
# Set root path
if(file.exists("C:/Users/sbogutzky/Desktop/data"))
  root.path <- "C:/Users/sbogutzky/Desktop/data/"
...
for (activity in activities) {
  for (user in users) {
    ...
    data.1 <- rbind(data.1, data.frame(subject = subjects, date = dates, measurement = measurements, fss.features[, 1:5], hrv.features[, c(3:6, 11:12, 17:18, 24:25, 45:46)], jc.features[e.seq, 1:2], cls.features[, 1:2]))
