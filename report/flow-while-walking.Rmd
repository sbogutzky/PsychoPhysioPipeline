...
```{r process-data, echo=FALSE}
  ...
  plot(data[, 1], data[, 2], xlab = "", ylab = expression(Psi[m](tk) / (2 * pi * m)), xlim = c(600, 900), ylim = c(0, 1), pch = 21)
  ...
  plot(t.s, hrv.data$HR, xlab = "", ylab = expression("HR ("~BPM~")"), xlim = c(600, 900), pch = 21)
  
  plot(t.s, hrv.data$FreqAnalysis[[1]]$HF, xlab = "", ylab = expression("HF ("~ms^2~")"), xlim = c(600, 900), pch = 21)
