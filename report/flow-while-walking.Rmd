...
for(i in unique(as.numeric(data.1$subject))) {
  ...
  plot(data.1.1$absorption ~ data.1.1$mean.pcoi, main = data.1.1$subject[1], ylab = "PCoI", xlab = "Absorption", pch = 21, bg = colors[1])
...
for(i in unique(as.numeric(data.2$subject))) {
  ...
  plot(data.2.1$absorption ~ data.2.1$mean.pcoi, main = data.2.1$subject[1], ylab = "PCoI", xlab = "Absorption", pch = 21, bg = colors[1])
...
for(i in unique(as.numeric(data.3$subject))) {
  ...
  plot(data.3.1$absorption ~ data.3.1$mean.pcoi, main = data.3.1$subject[1], ylab = "PCoI", xlab = "Absorption", pch = 21, bg = colors[1])
...
for(i in unique(as.numeric(data.4$subject))) {
  ...
  plot(data.4.1$absorption ~ data.4.1$mean.pcoi, main = data.4.1$subject[1], ylab = "PCoI", xlab = "Absorption", pch = 21, bg = colors[1])
