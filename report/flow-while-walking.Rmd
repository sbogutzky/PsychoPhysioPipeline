...
for(i in unique(as.numeric(data.4$subject))) {
  ...
  plot(data.4.1$meanhr ~ data.4.1$absorption, main = data.4.1$subject[1], xlab = "Absorption", ylab = "Mean HR", pch = 21, bg = colors[1])
  mod <- lm(data.4.1$meanhr ~ data.4.1$absorption)
  abline(mod)
  ...
  plot(data.4.1$rmssd ~ data.4.1$absorption, main = data.4.1$subject[1], xlab = "Absorption", ylab = "RMSSD", pch = 21, bg = colors[1])
  mod <- lm(data.4.1$rmssd ~ data.4.1$absorption)
  abline(mod)
  ...
  plot(data.4.1$mean.jerk.cost ~ data.4.1$absorption, main = data.4.1$subject[1], xlab = "Absorption", ylab = "Jerk Cost", pch = 21, bg = colors[1])
  mod <- lm(data.4.1$mean.jerk.cost ~ data.4.1$absorption)
  abline(mod)
  ...
  plot(data.4.1$mean.cycle.interval ~ data.4.1$absorption, main = data.4.1$subject[1], xlab = "Absorption", ylab = "Cycle Interval", pch = 21, bg = colors[1])
  mod <- lm(data.4.1$mean.cycle.interval ~ data.4.1$absorption)
  abline(mod)
  ...
  plot(data.4.1$mean.pcoi ~ data.4.1$absorption, main = data.4.1$subject[1], xlab = "Absorption", ylab = "PCoI", pch = 21, bg = colors[1])
  mod <- lm(data.4.1$mean.pcoi ~ data.4.1$absorption)
  abline(mod)
  ...
  plot(data.4.1$mean.nsei ~ data.4.1$absorption, main = data.4.1$subject[1], xlab = "Absorption", ylab = "NSEI", pch = 21, bg = colors[1])
  mod <- lm(data.4.1$mean.nsei ~ data.4.1$absorption)
  abline(mod)
