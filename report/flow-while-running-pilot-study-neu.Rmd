...
```{r indicator-session-wise, echo=FALSE, warning=FALSE, results="asis"}
  ...
  rownames(feature.table) <- c("Generalfaktor", "Glatter Verlauf", "Absorbiertheit", "Herzfrequenz ($BPM$)", "RMSSD ($ms$)", "Norm. Shan. Entr. Index", "Bewegungsaufw. ($m^2s^{-5}$)")
...
```{r indicator-measurement-wise, echo=FALSE, warning=FALSE, results="asis"}
...
title("Cberforderung: - Absorbiertheit: 3.75")
