...
data.2 <- data.1[as.numeric(measurement) == 1 | as.numeric(measurement) == 2, ]
...
par(mfcol = c(3, 4), xaxs = "r", yaxs = "r")
PlotLinearRegression(data.2$mean.cycle.interval, data.2$mean.jerk.cost, xlab = "Mean Cycle Interval", ylab = "Mean Jerk Cost")
PlotLinearRegression(data.2$mean.cycle.interval, data.2$coh, xlab = "Mean Cycle Interval", ylab = "Coherence")
PlotLinearRegression(data.2$coh, data.2$mean.jerk.cost, xlab = "Coherence", ylab = "Mean Jerk Cost")

PlotLinearRegression(data.2$flow, data.2$mean.jerk.cost, xlab = "Flow", ylab = "Mean Jerk Cost")
PlotLinearRegression(data.2$absorption, data.2$mean.jerk.cost, xlab = "Absorption", ylab = "Mean Jerk Cost")
PlotLinearRegression(data.2$fluency, data.2$mean.jerk.cost, xlab = "Fluency", ylab = "Mean Jerk Cost")

PlotLinearRegression(data.2$flow, data.2$mean.cycle.interval, xlab = "Flow", ylab = "Mean Cycle Interval")
PlotLinearRegression(data.2$absorption, data.2$mean.cycle.interval, xlab = "Absorption", ylab = "Mean Cycle Interval")
PlotLinearRegression(data.2$fluency, data.2$mean.cycle.interval, xlab = "Fluency", ylab = "Mean Cycle Interval")

PlotLinearRegression(data.2$flow, data.2$coh, xlab = "Flow", ylab = "Coherence")
PlotLinearRegression(data.2$absorption, data.2$coh, xlab = "Absorption", ylab = "Coherence")
PlotLinearRegression(data.2$fluency, data.2$coh, xlab = "Fluency", ylab = "Coherence")
```
