...
# Setup tikz device
tikz("./tikz/5_8_regression_analyse.tex", width = 5.22, height = 5.22)
...
grid(col = rgb(186/255, 187/255, 194/255))
box()
mtext("A", side = 2, line = 1, padj = -4, las = 1)
...
grid(col = rgb(186/255, 187/255, 194/255))
box()
mtext("B", side = 2, line = 1, padj = -4, las = 1)
...
grid(col = rgb(186/255, 187/255, 194/255))
box()
mtext("C", side = 2, line = 1, padj = -4, las = 1)
...
# Setup tikz device
tikz("./tikz/5_9_prozessorientierter-ansatz.tex", width = 7.91, height = 5.22)
...
\begin{sidewaysfigure}
	\input{./tikz/5_9_prozessorientierter-ansatz}
