...
print(sd(study.data$absorption))
print(sd(study.data$fluency))
print(sd(study.data$demand_level))
print(sd(study.data$pc))
print(sd(study.data$nse))
...
linear.model <- lm(absorption ~ grp, data = study.data)
