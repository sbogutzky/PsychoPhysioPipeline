...
# Load fss data 
fss.data <- read.csv(paste("/Users/simonbogutzky/Entwicklung/bogutzky/repositories/non-disruptive-flow-measures/", format(start.time, format="%Y-%m-%d--%H-%M-%S", tz="CET"), "/fss-data.csv", sep=""), header=T)
...
# Load ecg data 
ecg.data <- read.csv(paste("/Users/simonbogutzky/Entwicklung/bogutzky/repositories/non-disruptive-flow-measures/", format(start.time, format="%Y-%m-%d--%H-%M-%S", tz="CET"), "/ecg-data.csv", sep=""), header=T)
...
file.name <- "ecg-data"
file.path <- paste("/Users/simonbogutzky/Entwicklung/bogutzky/repositories/non-disruptive-flow-measures/", format(start.time, format="%Y-%m-%d--%H-%M-%S", tz="CET"), "/", sep="")
