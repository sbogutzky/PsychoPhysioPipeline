...
```{r setup, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  fss.features <- read.csv("./data/features/fss-features.csv")
  hrv.features <- read.csv("./data/features/hrv-features.csv")
...
```{r fks-merkmale, echo=FALSE, message=FALSE, results="asis"}
  ...
  # Subset features
    fss.features.subset         <- fss.features[start.time + 60 * 60 * 24 > as.POSIXct(fss.features[,12], tz="CET") & as.POSIXct(fss.features[,12], tz="CET") > start.time, c(1:10, 14)]
...
```{r bewertete-absorbiertheit, echo=FALSE, warning=FALSE, dev='pdf', fig.height=2.5, fig.width=6.5, fig.pos='htbp', fig.cap='Bewertete Absorbiertheit'}
  ...
  # Plot data
  plot(fss.features.subset[,5], type="b", xlab ="Zeitpunkt", ylab="Absorbiertheit", pch=21, ylim=c(3, 6), xaxt="n", yaxt="n")

  # Plot ticks
  axis(1, at=1:5, label=format(as.POSIXct(fss.features.subset[,11]),"%H:%M:%S"))
