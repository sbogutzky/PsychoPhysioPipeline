...
```{r setup, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  leg.motion.features       <- read.csv("./data/features/leg-motion-features.csv", stringsAsFactors = F)
  ...
  leg.motion.feature.subset <- leg.motion.feature.subset[, c(1:2, 4, 8)]
  leg.motion.feature.subset <- leg.motion.feature.subset[order(as.Date(leg.motion.feature.subset$activity.start,format = "%Y-%m-%d %H:%M:%S")), , drop = FALSE]
...
```{r variance-analysis, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
  ...
  plotFeaturesInGroups(hrv.feature.subset[, 1:9], hrv.feature.subset$measurement)
  ...
  checkFeaturesNormalityInGroups(hrv.feature.subset[, 1:9], hrv.feature.subset$measurement, T)
...
```{r correlation-analysis, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
  ...
  hrv.feature.subset.running <- hrv.feature.subset[hrv.feature.subset$measurement != "Ruhe", 1:9]
