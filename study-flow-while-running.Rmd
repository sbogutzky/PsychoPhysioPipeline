...
```{r calculate-fss-features, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  # Set file path 
  file.path <- paste("C:/Users/Simon Bogutzky/Documents/Entwicklung/non-disruptive-flow-measures/data/", format(start.time, format="%Y-%m-%d--%H-%M-%S", tz="CET"), "/", sep="")
...
```{r save-features, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  # Append data
  if(file.exists("C:/Users/Simon Bogutzky/Documents/Entwicklung/non-disruptive-flow-measures/data/features.csv")) {
    features <- read.csv("C:/Users/Simon Bogutzky/Documents/Entwicklung/non-disruptive-flow-measures/data/features.csv")
    write.csv(rbind(features, cbind(fss.features, hrv.features)), "C:/Users/Simon Bogutzky/Documents/Entwicklung/non-disruptive-flow-measures/data/features.csv", row.names=FALSE)
  } else {
    write.csv(cbind(fss.features, hrv.features), "C:/Users/Simon Bogutzky/Documents/Entwicklung/non-disruptive-flow-measures/data/features.csv", row.names=FALSE)
  }
```
