...
Die statische Analyse der einzelnen Merkmale führte ich mit R durch. Den Effekt des Zeitpunkts der Messung von Baseline bis zur Minute 60 des Laufens evaluierte ich mit einer einfachen ANOVA bei wiederholten Messungen (ggf. mit Greenhouse-Geisser oder Huynh-Feldt Korrektur). Um der Annahme der Normalverteilung folge zu leisten testete ich die Merkmale jedes Messabschnitts zahlenmäßig mit dem Shapiro Test und visuell in QQ-Plots. Das Merkmal Besorgnis entfernte ich aus der Datensammlung, da der Läufer sie niedrig und mit sehr wenig Abweichung bewertete. Einen abhängigen t-Test (auch Paardifferenzentest; engl. Paired t-Test) führte ich falls nötig durch, um die mittlere Differenz zweier Messabschnitte zu berechnen. 
...
```{r repeated-anova, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
  ...
  #   print(summary(aov.out))
    ...
    print(with(df, pairwise.t.test(value, treatment, p.adjust.method = "bonferroni", paired = T)))
  }
...
<!-- Der berechnete t-Wert 3.254 von liegt über dem kritischen t-Wert von 1.812. Somit kann davon ausgegangen werden, dass die durchschnittliche Absorbiertheit der beiden Aktivitäten unterschiedlich hoch ist. Die Absorbiertheit in Ruhe sind also im Durchschnitt niedriger als die beim Laufen. -->  

<!-- Ein p-Wert von 0,05 oder geringer bedeutet demnach, dass die beiden Mittelwerte in den beiden Grundgesamt￼heiten zu einem Signifikanzniveau von mindestens 95 % unterschiedlich sind. -->
