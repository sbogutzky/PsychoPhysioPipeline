...
\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=0.5\textwidth]{./figures/equipment-arrangement.png}
...
### Datenverarbeitung
#### Flow-Kurzskala
Aus den Fragebogen Daten berechnete die Faktoren der \ac{FKS}. In Tabelle \ref{tab:ergebisse-fks} sind die Ergebnisse der \ac{FKS} des Laufes vom Donnerstag, den 31. Oktober 2013 dargestellt. In diesem Lauf z. B. steigt die \ac{AFP} kontinuirlich und am Ende des Laufes bewertet der Läufer sein Flow-Erleben am höchsten. 
...
```{r calculate-fss-features, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  fss.features <- data.frame(stringsAsFactors = FALSE)
...
```{r figure-02, eval=TRUE, echo=FALSE, fig.height=2.5, fig.width=6.5, dev=c('pdf'), fig.show='hide', warning=FALSE}
...
```{r figure-03, eval=TRUE, echo=FALSE, fig.width=6.5, dev=c('pdf'), warning=FALSE}
  ...
  polygon(c(start, start, end, end), c(-10, 10, 10, -10), col = rgb(1, 1, 0, .1), border = rgb(0, 0, 0, 0))
...
#     boxplot(features[,i]  ~ m, data = features, title = colnames(features)[i])
    ...
    means     <- aggregate(features[, 2], list(features[, 1]), mean.na.rm)
    sds       <- aggregate(features[, 2], list(features[, 1]), sd.na.rm)
    ...
    # Store values
    row <- cbind(means[1, 2], sds[1, 2], means[2, 2], sds[2, 2], p)
...
| Merkmal                 | Baseline | Laufen |         |
|-------------------------|---------:|-------:|:--------|
|                         | M (SD)   | M (SD) | P       |
|-------------------------|----------|--------|---------|
| Generalfaktor           | `r format(round(table.data[1, 1], 2), nsmall=2)` (`r format(round(table.data[1, 2], 2), nsmall=2)`) | `r format(round(table.data[1, 3], 2), nsmall=2)` (`r format(round(table.data[1, 4], 2), nsmall=2)`) | `r format(round(table.data[1, 5], 2), nsmall=2)` `r getSigString(table.data[1, 5])`|
| Glatter Verlauf         | `r format(round(table.data[2, 1], 2), nsmall=2)` (`r format(round(table.data[2, 2], 2), nsmall=2)`) | `r format(round(table.data[2, 3], 2), nsmall=2)` (`r format(round(table.data[2, 4], 2), nsmall=2)`) | `r format(round(table.data[2, 5], 2), nsmall=2)` `r getSigString(table.data[2, 5])`|  
| Absorbiertheit          | `r format(round(table.data[3, 1], 2), nsmall=2)` (`r format(round(table.data[3, 2], 2), nsmall=2)`) | `r format(round(table.data[3, 3], 2), nsmall=2)` (`r format(round(table.data[3, 4], 2), nsmall=2)`) | `r format(round(table.data[3, 5], 2), nsmall=2)` `r getSigString(table.data[3, 5])`|
| Besorgnis               | `r format(round(table.data[4, 1], 2), nsmall=2)` (`r format(round(table.data[4, 2], 2), nsmall=2)`) | `r format(round(table.data[4, 3], 2), nsmall=2)` (`r format(round(table.data[4, 4], 2), nsmall=2)`) | `r format(round(table.data[4, 5], 2), nsmall=2)` `r getSigString(table.data[4, 5])`|  
| AFP                     | `r format(round(table.data[5, 1], 2), nsmall=2)` (`r format(round(table.data[5, 2], 2), nsmall=2)`) | `r format(round(table.data[5, 3], 2), nsmall=2)` (`r format(round(table.data[5, 4], 2), nsmall=2)`) | `r format(round(table.data[5, 5], 2), nsmall=2)` `r getSigString(table.data[5, 5])`|
| Mittlere Herzrate (BPM)               | `r format(round(table.data[14, 1], 2), nsmall=2)` (`r format(round(table.data[14, 2], 2), nsmall=2)`) | `r format(round(table.data[14, 3], 2), nsmall=2)` (`r format(round(table.data[14, 4], 2), nsmall=2)`) | `r format(round(table.data[14, 5], 2), nsmall=2)` `r getSigString(table.data[14, 5])`| 
| LF (ms^2^)  | `r format(round(table.data[6, 1], 2), nsmall=2)` (`r format(round(table.data[6, 2], 2), nsmall=2)`) | `r format(round(table.data[6, 3], 2), nsmall=2)` (`r format(round(table.data[6, 4], 2), nsmall=2)`) | `r format(round(table.data[6, 5], 2), nsmall=2)` `r getSigString(table.data[6, 5])`| 
| HF-VHF (ms^2^)              | `r format(round(table.data[7, 1], 2), nsmall=2)` (`r format(round(table.data[7, 2], 2), nsmall=2)`) | `r format(round(table.data[7, 3], 2), nsmall=2)` (`r format(round(table.data[7, 4], 2), nsmall=2)`) | `r format(round(table.data[7, 5], 2), nsmall=2)` `r getSigString(table.data[7, 5])`|
|  Total (ms^2^)        | `r format(round(table.data[13, 1], 2), nsmall=2)` (`r format(round(table.data[13, 2], 2), nsmall=2)`) | `r format(round(table.data[13, 3], 2), nsmall=2)` (`r format(round(table.data[13, 4], 2), nsmall=2)`) | `r format(round(table.data[13, 5], 2), nsmall=2)` `r getSigString(table.data[13, 5])` | 
| LF (%)        | `r format(round(table.data[8, 1], 2), nsmall=2)` (`r format(round(table.data[8, 2], 2), nsmall=2)`) | `r format(round(table.data[8, 3], 2), nsmall=2)` (`r format(round(table.data[8, 4], 2), nsmall=2)`) | `r format(round(table.data[8, 5], 2), nsmall=2)` `r getSigString(table.data[8, 5])`|
| HF-VHF (%)          | `r format(round(table.data[9, 1], 2), nsmall=2)` (`r format(round(table.data[9, 2], 2), nsmall=2)`) | `r format(round(table.data[9, 3], 2), nsmall=2)` (`r format(round(table.data[9, 4], 2), nsmall=2)`) | `r format(round(table.data[9, 5], 2), nsmall=2)` `r getSigString(table.data[9, 5])`| 
| LF (n. u.)                   | `r format(round(table.data[10, 1], 2), nsmall=2)` (`r format(round(table.data[10, 2], 2), nsmall=2)`) | `r format(round(table.data[10, 3], 2), nsmall=2)` (`r format(round(table.data[10, 4], 2), nsmall=2)`) | `r format(round(table.data[10, 5], 2), nsmall=2)` `r getSigString(table.data[10, 5])`| 
| HF-VHF (n. u.)             | `r format(round(table.data[11, 1], 2), nsmall=2)` (`r format(round(table.data[11, 2], 2), nsmall=2)`) | `r format(round(table.data[11, 3], 2), nsmall=2)` (`r format(round(table.data[11, 4], 2), nsmall=2)`) | `r format(round(table.data[11, 5], 2), nsmall=2)` `r getSigString(table.data[11, 5])`| 
| LF/HF-VHF             | `r format(round(table.data[12, 1], 2), nsmall=2)` (`r format(round(table.data[12, 2], 2), nsmall=2)`) | `r format(round(table.data[12, 3], 2), nsmall=2)` (`r format(round(table.data[12, 4], 2), nsmall=2)`) | `r format(round(table.data[12, 5], 2), nsmall=2)` `r getSigString(table.data[12, 5])` | 

Table: Unterschied zwischen Baseline-Messungen und Laufmessungen

## Unterschied zwischen Baseline-Messungen und Laufmessungen

Um zu testen, ob ein Unterschied zwischen den erhobenen Merkmalen aus den Baseline-Messungen und den Laufmessungen besteht, führte ich eine einfaktorielle Varianzanalyse (ANOVA) für jedes Merkmal. Das Ergebnis zeigt, dass alle Merkmale, außer dem Generalfaktor und dem Besorgnisfaktor, sich mindestens signifikant zwischen Baseline-Messungen und Laufmessungen unterscheiden. Das Ergebnis unterstützt meine Entscheidung Absorbiertheit als Maßzahl zur benutzen.  
