...
<!--
  () - Ohne Ausreißer Datensatz Lauf 3 45' wegen Pause Prüfen
  Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
  
  flow ~ hf.power.r p < 0.1 . Hohe Werte des Gesamtfaktors korrelieren linear mit niedrigen relativen Werten der HF r = 0.37 (0.39)
  ...
  flow ~ lfhf p < 0.1 . (0.05 *) Hohe Werte des Gesamtfaktors korrelieren linear mit dem hohen Werten von LF/HF r = 0.36 (0.42)
  
  fluency ~ hf.power.r p < 0.05 * Hohe Werte des glatten Verlaufs korrelieren linear mit niedrigen relativen Werten der HF r = 0.42 (0.44)
  (fluency ~ hf.power.r p < 0.1 . Hohe Werte des glatten Verlaufs korrelieren mit moderaten relativen Werten der HF r2 = 0.22)
  (fluency ~ lf.power.nu p < 0.1 . Hohe des glatten Verlaufs korrelieren linear mit hohen normalisierten Werten der LF r = 0.41)
  (fluency ~ hf.power.nu p < 0.1 . Hohe Werte des glatten Verlaufs korrelieren linear mit niedrigen normalisierten Werten der HF r = 0.41)
