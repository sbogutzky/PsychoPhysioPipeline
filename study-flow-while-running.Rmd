...
<!--
  () - Ohne Ausreißer Datensatz 11 
  Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
  
  flow ~ hf.power.r p < 0.1 . Hohe Werte des Gesamtfaktors korrelieren linear mit niedrigen relativen Werten der HF r = 0.36 (0.39)
  flow ~ lf.power.nu p < 0.1 . Hohe des Gesamtfaktors korrelieren linear mit hohen normalisierten Werten der LF r = 0.34 (0.41)
  flow ~ hf.power.nu p < 0.1 . Hohe Werte des Gesamtfaktors korrelieren linear mit niedrigen normalisierten Werten der HF r = 0.34 (0.41)
  flow ~ lfhf p < 0.05 * (0.1 .) Hohe Werte des Gesamtfaktors korrelieren linear mit dem hohen Werten von LF/HF r = 0.36 (0.42)
  
  fluency ~ hf.power.r p < 0.05 . Hohe Werte des glatten Verlaufs korrelieren linear mit niedrigen relativen Werten der HF r = 0.41 (0.44)*
  (fluency ~ hf.power.r p < 0.1 . Hohe Werte des glatten Verlaufs korrelieren mit moderaten relativen Werten der HF r2 = 0.21)
  fluency ~ lf.power.nu p < 0.1 . Hohe des glatten Verlaufs korrelieren linear mit hohen normalisierten Werten der LF r = 0.34 (0.41)
  fluency ~ hf.power.nu p < 0.1 . Hohe Werte des glatten Verlaufs korrelieren linear mit niedrigen normalisierten Werten der HF r = 0.34 (0.41)
  fluency ~ lfhf p < 0.1 . Hohe Werte des glatten Verlaufs korrelieren linear mit dem hohen Werten von LF/HF r = 0.35 (0.41)
  
  fit ~ mean.hr p < 0.001 ***  Hohe AFP Werte korrelieren linear mit hohen Werten der mittleren Herzrate r = 0.67 (0.69)*
  fit ~ mean.hr p < 0.01 **  Hohe AFP Werte korrelieren mit moderaten Werten der mittleren Herzrate r2 =  0.46 (0.49)*
-->
